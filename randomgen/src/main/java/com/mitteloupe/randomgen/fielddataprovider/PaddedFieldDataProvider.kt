...
constructor(
	...
	private val fieldDataProvider: FieldDataProvider<OUTPUT_TYPE, *>
	...
	private fun getGeneratedString(instance: OUTPUT_TYPE?): String {
		return fieldDataProvider.generate(instance).toString()
	}
}
